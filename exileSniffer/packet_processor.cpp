		...
		while (true)
		{
			...
			if (!keyCandidate) {
				...
				if (msWaited % 2000 == 0)
				{
					...
					if (msWaited > 4000)
					{
						UIaddLogMsg("Warning: Long wait for memory key", 0, uiMsgQueue);
						if (msWaited > 12000)
						{
...
void packet_processor::handle_packet_to_gameserver(byte* data, unsigned int dataLen, long long timems)
{
